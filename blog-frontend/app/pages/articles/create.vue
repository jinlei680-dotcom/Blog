      ...
      <form class="editor-form" @submit.prevent="handleSubmit">
        ...
        <div class="form-group">
          ...
          <div class="writing-stats">
            ...
            <span class="stat-sep draft-saved-sep" v-if="lastSavedAt">·</span>
...
// Draft
const draftKey = computed(() => `draft_article_${authStore.user?.id}`)
const { saveDraft, loadDraft, clearDraft, hasDraft, formatDraftTime } = useDraft(draftKey.value)
